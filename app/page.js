...
export default function HomePage() {
    ...
    return <main className="w-full min-h-screen flex justify-center p-4 sm:p-6 lg:p-8 flex-col pb-32">
        {/* Hero Section */}
        <section className="text-center mt-8 sm:mt-12 lg:mt-16 mb-12 max-w-4xl mx-auto">
            <div className="inline-block bg-blue-50 border border-blue-200 rounded-full px-4 py-2 mb-6">
                <span className="text-sm font-medium text-blue-700">Free • No Signup • Instant</span>
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                Make Your Links Work <span className="text-blue-600">Anywhere</span>
            </h1>
